...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  _updateUserAccount() async {
    ...
    && _passwordController.text.isEmpty && _confirmPasswordController.text.isEmpty) {
     ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(getTranslated('change_something_to_update', context)),
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(getTranslated('password_be_at_least', context)),
          backgroundColor: ColorResources.RED));
    }
        ...
        builder: (context, profile, child) {
          ...
          return Stack(
            ...
            children: [
              ...
              Container( height: deviceHeight > 600 ? 600 : 400,
              ...
              Container(
                padding: EdgeInsets.only(top: deviceHeight > 600 ? 600 : 400),
                child: Column(
                  children: [
                    Expanded(
                      child: Container(
                          ...
                          children: [
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      children: [
                                        Icon(Icons.email_outlined, color: ColorResources.getLightSkyBlue(context), size: 20),
                                        SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                            ...
                            Container(margin: EdgeInsets.only(
                              ...
                              child: Column(children: [
                                Row(children: [
                                  Icon(Icons.lock_open, color: ColorResources.getLightSkyBlue(context), size: 20),
                                  SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
