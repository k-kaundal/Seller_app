...
class AddProductScreen extends StatefulWidget {
  ...
  AddProductScreen({Key key, this.product, this.category, this.addProduct, this.editProduct}): super(key: key);
  @override
...
class _AddProductScreenState extends State<AddProductScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if(widget.product != null){
      ...
      Provider.of<SellerProvider>(context,listen: false).setProductTypeIndex(widget.product.productType == "physical"? 0 : 1, true) ;
      Provider.of<SellerProvider>(context,listen: false).setDigitalProductTypeIndex(widget.product.digitalProductType == "ready_after_sell"? 0 : 1, true) ;
    }else{
             ...
             return!resProvider.isLoading? Container(height: 50,
               ...
               onTap: (){
                 ...
                 if(_haveBlankTitle){
                   ...
                   resProvider.uploadDigitalProduct(Provider.of<AuthProvider>(context,listen: false).getUserToken()).then((value){
