                              ...
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                ...
                                Expanded(
                                  child: Column( crossAxisAlignment: CrossAxisAlignment.start,children: [
                                    Container(
                                      child: Text('Title : ${shipProv.shippingList[index].title}',
                                    ...
                                    Row(mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Text('${PriceConverter.convertPrice(context, shipProv.shippingList[index].cost)}',
                                            style: titilliumRegular.copyWith(color: ColorResources.getHint(context),
                                                fontSize: Dimensions.FONT_SIZE_SMALL)),
                                      SizedBox(width: 10,),
                                        Icon(Icons.access_time_sharp, color: Colors.grey,size: Dimensions.ICON_SIZE_DEFAULT,),
                                        SizedBox(width: 5,),
                                        Text('${shipProv.shippingList[index].duration}days',
                                            style: titilliumRegular.copyWith(color: ColorResources.getHint(context),
                                                fontSize: Dimensions.FONT_SIZE_SMALL)),
                                  ...
                                  Row(children: [
                                    InkWell(
                                      onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (_) => ShippingMethodScreen(shipping: shipProv.shippingList[index]))),
                                    ...
                                    InkWell(
                                      onTap: (){
                                        ...
                                        child: Container(width: Dimensions.ICON_SIZE_LARGE, child: Image.asset(Images.delete)))
