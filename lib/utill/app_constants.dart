...
class AppConstants {
  ...
  static const String APP_NAME = 'Widgets Hubs';
  static const String MAXIMUM_FILE_SIZE_FOR_UPLOAD = '2';
  static const String COMPANY_NAME = 'Widgets Hubs';
  static const String BASE_URL = 'https://widgetshubs.org';
  ...
  static const String PRODUCT_REVIEW_STATUS_ON_OFF = '/api/v2/seller/shop-product-reviews-status';
  static const String ATTRIBUTE_URI = '/api/v1/attributes';
  static const String BRAND_URI = '/api/v2/seller/brands';
  ...
  static const String BAR_CODE_GENERATE = '/api/v2/seller/products/barcode/generate';
  static const String DIGITAL_PRODUCT_UPLOAD = '/api/v2/seller/products/upload-digital-product';
  static const String DIGITAL_PRODUCT_UPLOAD_AFTER_SELL = '/api/v2/seller/orders/order-wise-product-upload';
  static const String REGISTRATION = '/api/v2/seller/registration';
